add_custom_target(CopySPlisHSPlasHShaders
	...
	${CMAKE_RUNTIME_OUTPUT_DIRECTORY}/data/shaders
...
add_custom_target(CopyEmitterModels
	...
	${CMAKE_RUNTIME_OUTPUT_DIRECTORY}/data/emitter_boundary
...
add_custom_target(CopyPBDShaders
	...
	${CMAKE_RUNTIME_OUTPUT_DIRECTORY}/data/pbd_shaders
...
add_custom_target(CopyImguiFonts
	...
	${CMAKE_RUNTIME_OUTPUT_DIRECTORY}/data/fonts
