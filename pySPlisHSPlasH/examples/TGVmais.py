...
def main():
    ...
    scene.boundaryModels.append(Scenes.BoundaryData(meshFile="../models/UnitBox.obj", translation=[0., 0, 0.], scale=[5., 5., 0.5], color=[0.1, 0.4, 0.5, 1.0], isWall=True, mapInvert=False, mapResolution=[25, 25, 25], isDynamic=False))
    ...
    scene.fluidBlocks.append(Scenes.FluidBlock(id='Fluid', boxMin = [-2.5, -2.5, -0.32], boxMax = [2.5 , 2.5, 0.32], mode=0, initialVelocity=[0.0, 0.0, 0.0]))
