import sys
import os
os.chdir(r"/home/tn774736/Documents/SPlisHSPlasH")
...
def main():
    ...
    # scene.boundaryModels.append(Scenes.BoundaryData(meshFile="/home/tn774736/Documents/SPlisHSPlasH/data/models/UnitBox.obj", translation=[0., 0.5, 0.], scale=[2., 3., 0.5], color=[0.1, 0.4, 0.5, 1.0], isWall=True, mapInvert=True, mapResolution=[25, 25, 25], isDynamic=False))
    # scene.boundaryModels.append(Scenes.BoundaryData(meshFile="/home/tn774736/Documents/SPlisHSPlasH/data/models/UnitBox.obj", translation=[-14., 1.5, 0.], scale=[30., 1., 0.5], color=[0.1, 0.4, 0.5, 1.0], isAnimated=True, isWall=False, mapInvert=False))
