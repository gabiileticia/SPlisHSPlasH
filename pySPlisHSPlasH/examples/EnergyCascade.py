...
def main():
    ...
    scene.boundaryModels.append(Scenes.BoundaryData(meshFile="../models/UnitBox.obj", translation=[0., 0.5, 0], scale=[4., 1., 2.], color=[0.1, 0.4, 0.5, 1.0], isWall=True, mapInvert=False, mapResolution=[25, 25, 25], isDynamic=False))
    ...
    scene.fluidBlocks.append(Scenes.FluidBlock(id='Fluid', boxMin = [-2, 0.0, -1], boxMax = [2 , 1.0, 1], mode=0, initialVelocity=[0.0, 0.0, 0.0]))
